...
from fungsi_prisma_segitiga import hitung_luas, hitung_volume
...
txttinggiprisma.grid(row=6, column=0, sticky=W, padx=5, pady=5)


def hitung():
    hasil_luas = hitung_luas(txtpanjangalas.get(), txttinggialas.get(), txttinggiprisma.get())
    hasil_volume = hitung_volume(txtpanjangalas.get(), txttinggialas.get(), txttinggiprisma.get())
